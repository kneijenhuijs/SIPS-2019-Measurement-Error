...
*Will insert simulation results when they're done*

*Simulations will be on the effect of measurement error on effect sizes*

<div class="centered">
![](Pictures/construct.png)
</div>
...
## Ideas for questions and statements
